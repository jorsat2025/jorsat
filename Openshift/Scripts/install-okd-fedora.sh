...
/usr/bin/rm -f /var/www/html/okd4/*.ign

echo "Copio los ignition Nuevos"
/usr/bin/cp -pr /root/okd-install/*.ign /var/www/html/okd4/

echo "Doy permisos a los ignition"
/usr/sbin/restorecon -vR /var/www/html/
/usr/bin/chmod o+r /var/www/html/okd4/
/usr/bin/chmod 777 /var/www/html/okd4/*.ign
